...
public class StudentController {
    ...
    public double sumAllAges() {
        return studentService.sumAllAges();
    }

    @GetMapping("/mayoredad")
    public double getOlderAge() {
        return studentService.getOlderAge();
    }
    ...
    @GetMapping("/nombreestudiantes")
    public String getName(){
        return studentService.getName();
    }

    @GetMapping("/estudiantesmayoresconc")
    public List<Student> getEstudentsOlderAndC(){
        return studentService.getEstudentsOlderAndC();
    }

    @GetMapping("/estudiantesmenorescons")
    public List<Student> getEstudentsYoungerAndS(){
        return studentService.getEstudentsYoungerAndS();
    }

    @GetMapping("/listartresestudiantesmasgrandes")
    public List<Student> getThreeOlderStudents(){
        return studentService.getThreeOlderStudents();
    }
